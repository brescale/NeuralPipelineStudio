        ...
        public static NeuralPipelineSettings GenerateOptimalSettings(HardwareProfile profile)
        {
            ...
            switch (profile.Tier)
            {
                case HardwareTier.Enthusiast: // 16GB - 24GB (RTX 4090, 4080)
                    ...
                    s.NeuralPass1Intensity = 1.8f;
                    s.NeuralPass1DiffuseWhiteNits = 180.0f;
                    s.SuperResolutionRatio = 2.2f;
                    s.DlssNrPasses = 20;
                    s.DlssNrTransferStrength = 1.75f;
                ...
                case HardwareTier.Mainstream: // 8GB (RTX 4060, 3070, RX 6700)
                    ...
                    s.NeuralPass1Intensity = 1.4f;
                    s.NeuralPass1DiffuseWhiteNits = 180.0f;
                    s.SuperResolutionRatio = 2.2f;
                    s.DlssNrPasses = 10;
                    s.DlssNrTransferStrength = 1.50f;
                    s.DlssNrWhitePointTrim = 1.0f;
                    s.DlssNrLocalStructure = 1.8f;
                    s.DlssNrSkinStructure = 1.8f;
                    s.DlssNrIntensity = 1.8f;
                    s.RtaoEnabled = true;
                ...
                case HardwareTier.Entry: // 4GB - 6GB (RTX 3050, GTX 1660)
                    ...
                    s.NeuralPass1DiffuseWhiteNits = 180.0f;
                    s.SuperResolutionRatio = 2.0f;
                    s.DlssNrPasses = 6;
                    s.DlssNrTransferStrength = 1.20f;
                    s.DlssNrWhitePointTrim = 1.0f;
                    s.DlssNrLocalStructure = 1.5f;
                    s.DlssNrSkinStructure = 1.5f;
                    s.DlssNrIntensity = 1.5f;
                    s.RtaoEnabled = false;
                    s.LsaoEnabled = false;
                    s.SssrEnabled = false;
                    s.BloomEnabled = true;
